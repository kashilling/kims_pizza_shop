...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { cost: @pizza.cost, date_created: @pizza.date_created, name: @pizza.name, time_put_in: @pizza.time_put_in, time_to_cook: @pizza.time_to_cook, topping: @pizza.topping }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { cost: @pizza.cost, date_created: @pizza.date_created, name: @pizza.name, time_put_in: @pizza.time_put_in, time_to_cook: @pizza.time_to_cook, topping: @pizza.topping }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
